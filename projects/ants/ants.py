...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if type(insect) != QueenAnt or insect.num_of_queens > 1: #Ensures you can't remove the one true queen!
...
class Insect(object):
    ...
    watersafe = False # Insect is not watersafe by default
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        if not insect.watersafe:
            insect.reduce_armor(insect.armor) # Kills insect
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, colony):
        ...
        if (self.num_of_queens > 1):
            ...
            while(place != None):
                if (place.ant): # If place is accupied
                ...
                place = place.exit # Move to next place
